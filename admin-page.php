  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link active" style="margin-right: 30px; color: orange;" href="admin-page.php">HOME</a>
        </li>
        <li class="nav-item">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <a class="btn btn-xs btn-warning" style="color: #fff;" href="edit.php?id=<?php echo $d['id_wisata']; ?>">Edit</a>
                </td>
                <td>
