    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" style="margin-right: 30px; color: orange;" href="admData_pengguna.php">DATA PENGGUNA</a>
                </li>
                <li class="nav-item">
        ...
        <div class="container" align="center">
            <div class="row justify-content-center pb-4">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    <h2 class="mb-2">Halaman Pengguna</h2>
                </div>
            </div>
            <div style="height: 370px;overflow-y: scroll;background-color: white;">
                <table border="1px" class="table table-bordered table-hover table-striped" width="100%">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['cari'])) {
                            $cari = $_GET['cari'];
                            $data = mysqli_query($connect, "select * from tb_pengguna where nama_lengkap like '%" . $cari . "%'");
                        } else {
                            $data = mysqli_query($connect, "select * from tb_pengguna");
                        }
                        ...
                        ?>
                            <tr>
                                ...
                                <!-- <td><?php echo $d['terakhir_login']; ?></td> -->
                                <td><?php echo $d['tanggal_ditambahkan']; ?></td>

                                <td>
                                    <a class="btn btn-xs btn-warning" style="color: #fff;" href="edit-pengguna.php?id=<?php echo $d['id']; ?>">Edit</a>
                                </td>
                                <td>
                                    <a class="btn btn-xs btn-danger" href="delete-pengguna.php?id=<?php echo $d['id']; ?>" onclick="return confirm('Hapus data?')">Hapus</a>
                                </td>
                            </tr>
                        <?php
                        }
                ...
                <a href="tambah-pengguna.php" style="margin-top: 13px;" class="btn btn-primary">Tambah</a>
            </div>
        </div>
    </section>
