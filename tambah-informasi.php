        ...
        <div class="container">
            <div class="row justify-content-center pb-4">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    <h2 class="mb-4">Tambah Informasi</h2>
                </div>
            </div>
            <form role="form" action="tambah-aksi-informasi.php" method="post" enctype="multipart/form-data">
                <div class="form-inline">
                    <div class="form-group">
                        <input type="text" name="nama_informasi" class="form-control" id="exampleInputEmail2" placeholder="Nama Informasi">
                    </div>
                </div><br>
                <div class="form-inline">
                    <div class="form-group">
                        <input type="datetime-local" name="tanggal_upload" class="form-control" id="exampleInputEmail2" placeholder="Tanggal Upload">
                    </div>
                    <div class="form-group" style="margin-left: 7px;margin-right: 10px;">
                        <label for="">Upload Foto</label>
                        <input type="file" name="foto" class="form-control" id="exampleInputPassword2">
                    </div>
                </div><br>
                <div class="form-group">
                    <input type="text" class="form-control" name="deskripsi" id="exampleInputEmail1" placeholder="Deskripsi">
                </div>
