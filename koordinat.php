...
<body>
  ...
  <div class="hero-wrap js-fullheight" style="background: url('images/gm-index.jpg') no-repeat center center fixed;background-size: cover ;" data-stellar-background-ratio="0.5">

    <div class="container" style="padding-top: 10px;">
      <img src="images/LOGO_VAC_TRIP.png" align="center">
      <HR style="color:white;">
      <h6 style="color: white;" align="center">SIKAHKAN TANDAI LOKASI</h6>
      <HR>
      ...
      <script>
        ...
        function initialize() {
          var propertiPeta = {
            center: new google.maps.LatLng(-7.892798985278896, 110.14040274971484),
            zoom: 13,
