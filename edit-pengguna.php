...
<head>
    ...
    include "koneksi.php";
    $id = $_GET['id'];
    $query_mysql = mysqli_query($connect, "SELECT * FROM tb_pengguna WHERE id='$id'") or die(mysqli_error($connect));
    $nomor = 1;
    ?>
</head>
    ...
    <section class="ftco-section testimony-section bg-bottom" style="background-image: url(images/bg_3.jpg);">
        <div class="container">
            ...
            <?php while ($data = mysqli_fetch_array($query_mysql)) { ?>
                <form role="form" action="edit-aksi-pengguna.php" method="post" enctype="multipart/form-data">
                    <div class="form-inline">
                        <div class="form-group">
                            <input type="hidden" name="id" value="<?php echo $data['id'] ?>">
                            <!-- <input type="hidden" name="gambar" value="<?php echo $data['gambar'] ?>"> -->

                            <input type="text" name="nama_lengkap" value="<?php echo $data['nama_lengkap'] ?>" class="form-control" id="exampleInputEmail2" placeholder="Nama Lengkap">
                        </div>
                    </div><br>
                    <div class="form-inline">
                        <div class="form-group">
                            <input type="text" name="email" value="<?php echo $data['email'] ?>" class="form-control" id="exampleInputEmail2" placeholder="Email">
                        </div>
                        <div class="form-group" style="margin-left: 7px;margin-right: 10px;">
                            <input type="text" name="username" class="form-control" value="<?php echo $data['username'] ?>" id="exampleInputPassword2" placeholder="Username">
                        </div>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" value="<?php echo $data['password'] ?>" name="password" id="exampleInputEmail1" placeholder="Password">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" value="<?php echo $data['orang'] ?>" name="orang" id="exampleInputEmail1" placeholder="Orang">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" value="<?php echo $data['type'] ?>" name="type" id="exampleInputEmail1" placeholder="Type">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputFile">Tanggal Masuk</label>
                        <input type="datetime-local" name="tanggal_ditambahkan">
                        <input type="text" class="form-control" name="tanggal_ditambahkan" value="<?= $data['tanggal_ditambahkan'] ?>">
                    </div>
