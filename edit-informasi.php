...
<head>
    ...
    $query_mysql = mysqli_query($connect, "SELECT * FROM tb_informasi WHERE id_informasi='$id'") or die(mysqli_error($connect));
    $nomor = 1;
    ?>
</head>
        ...
        <div class="container">
            <div class="row justify-content-center pb-4">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    <h2 class="mb-4">Edit Informasi</h2>
                </div>
            </div>
            <?php while ($data = mysqli_fetch_array($query_mysql)) { ?>
                <form role="form" action="edit-aksi-informasi.php" method="post" enctype="multipart/form-data">
                    <div class="form-inline">
                        <div class="form-group">
                            <input type="hidden" name="id_informasi" value="<?php echo $data['id_informasi'] ?>">
                            <!-- <input type="text" name="nama_informasi" value="<?php echo $data['nama_informasi'] ?>" class="form-control"> \-->
                            <input type="text" name="nama_informasi" value="<?php echo $data['nama_informasi'] ?>" class="form-control">
                        </div>
                    </div><br>
                    <div class="form-inline">
                        <div class="form-group">
                            <input type="text" name="tanggal_upload" value="<?php echo $data['tanggal_upload'] ?>" class="form-control">
                        </div>
                        <div class="form-group" style="margin-left: 7px;margin-right: 10px;">
                            ...
                            <?php
                            $foto_url = "./upload/" . $data['foto'];
                            echo '<img name="foto" src="' . $foto_url . '" alt="Foto" style="width: 30%;">';
                            ?>
                            -<input type="file" name="foto" class="form-control">
                        </div>
                    </div><br>
                    <div class="form-group">
                        <input type="text" class="form-control" value="<?php echo $data['deskripsi'] ?>" name="deskripsi">
                    </div>
