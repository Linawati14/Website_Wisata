...
<body>
    ...
    <section class="ftco-section testimony-section bg-bottom" style="background-image: url(images/bg_3.jpg);">
        <div class="container">
            ...
            <form role="form" action="tambah-aksi-pengguna.php" method="post" enctype="multipart/form-data">
                <div class="form-inline">
                    <div class="form-group">
                        <input type="text" name="nama_lengkap" class="form-control" id="exampleInputEmail2" placeholder="Nama Lengkap">
                    </div>
                </div><br>
                <div class="form-inline">
                    <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="orang" id="exampleInputEmail1" placeholder="Orang (pengguna, admin)">
                </div>
                <div class="form-group">
                    <input type="number" class="form-control" name="type" id="exampleInputEmail1" placeholder="1/0">
                </div>
                <div class="form-group">
                    <input type="datetime-local" class="form-control" name="tanggal_ditambahkan">
                </div>
                <!-- <div class="form-group">
