    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" style="margin-right: 30px;" href=".php">HOME</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row">
            <div class="col-sm">
                <div class="container mt-2" style="background-color: white;">
                    <?php
                    $sql = "SELECT * FROM tb_wisata WHERE id_wisata = 137";
                    ...
                    if ($result) {
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<h4 class='mb-3'>" . $row["nama"] . "</h4>";
                                echo "<div class='gambar-container'>";
                                echo "<img src='./upload/{$row['gambar']}' alt='img'>";
                                echo "<div class='jarak'>" . $row["kategori"] . "</div>";
                                echo "</div>";
                                echo "<button class='btn btn-outline-secondary btn-rute' margin-left: 5px;'> <a href='https://www.google.com/maps/dir/-7.4403919,112.7032944/rute+museum+bale+agung/@-7.5581153,108.8115518,7z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x2e7afb3cb6bb06b1:0xa3a15824aa05dedf!2m2!1d110.1592558!2d-7.8582678?entry=ttu' style='color: black;'>Rute</a></button>";
                                echo "<br>";
                                echo "<br>";
                                echo "<span class='alamat-info'>" . $row["alamat"] . "</span>";
                            }
                        } else {
                            echo "Tidak ada data.";
                        }
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-4">
                            <div class="btn btn-warning btn-block" style="color: white; border: 1px solid black;">Rp.10.000</div>
                        </div>
                        <div class="col-sm-4">
