                        ...
                        <div class="col-md-8 col-lg-12 mx-auto">
                            ...
                            <div class="card shadow card-container">
                                <div class="card-body" style="background-color: white;">
                                    <form class="contact-form" action="daftar-pengguna-aksi.php" method="post">
                                        <h3 class="card-title mt-3" style="text-align: center;">DAFTAR</h3>
                                        <div class="form-group mt-4">
                                            <strong><label for="" style="font-size: 14px;">Nama Lengkap</label></strong>
                                            <input type="text" class="form-control" name="nama_lengkap" placeholder="Tuliskan nama lengkap anda">
                                        </div>
                                        <div class="form-group">
                                            <strong><label for="" style="font-size: 14px;">Email</label></strong>
                                            <input type="email" name="email" placeholder="Tuliskan email anda" class="form-control">
                                        </div>
                                        <div class="form-group">
